  ...
  return (
    <section className='banner__section' style={{
        ...
        <div className='banner__content'>
            ...
            <p className='banner__description'>Aprovecha las increibles ofertas que tenemos para vos desde el 10 de Enero hasta el 15 de Febrero. Comprando por transferencia bancaria tenes un 15% de descuento adicional.</p>
            <a href="#products">
